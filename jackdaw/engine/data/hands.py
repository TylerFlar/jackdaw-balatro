...
HAND_BASE: dict[HandType, HandBaseData] = {
    HandType.FLUSH_FIVE: HandBaseData(
        s_chips=160, s_mult=16, l_chips=50, l_mult=3, order=1, visible=False,
    ),
    HandType.FLUSH_HOUSE: HandBaseData(
        s_chips=140, s_mult=14, l_chips=40, l_mult=4, order=2, visible=False,
    ),
    HandType.FIVE_OF_A_KIND: HandBaseData(
        s_chips=120, s_mult=12, l_chips=35, l_mult=3, order=3, visible=False,
    ),
    HandType.STRAIGHT_FLUSH: HandBaseData(
        s_chips=100, s_mult=8, l_chips=40, l_mult=4, order=4, visible=True,
    ),
    HandType.FOUR_OF_A_KIND: HandBaseData(
        s_chips=60, s_mult=7, l_chips=30, l_mult=3, order=5, visible=True,
    ),
    HandType.FULL_HOUSE: HandBaseData(
        s_chips=40, s_mult=4, l_chips=25, l_mult=2, order=6, visible=True,
    ),
    HandType.FLUSH: HandBaseData(
        s_chips=35, s_mult=4, l_chips=15, l_mult=2, order=7, visible=True,
    ),
    HandType.STRAIGHT: HandBaseData(
        s_chips=30, s_mult=4, l_chips=30, l_mult=3, order=8, visible=True,
    ),
    HandType.THREE_OF_A_KIND: HandBaseData(
        s_chips=30, s_mult=3, l_chips=20, l_mult=2, order=9, visible=True,
    ),
    HandType.TWO_PAIR: HandBaseData(
        s_chips=20, s_mult=2, l_chips=20, l_mult=1, order=10, visible=True,
    ),
    HandType.PAIR: HandBaseData(
        s_chips=10, s_mult=2, l_chips=15, l_mult=1, order=11, visible=True,
    ),
    HandType.HIGH_CARD: HandBaseData(
        s_chips=5, s_mult=1, l_chips=10, l_mult=1, order=12, visible=True,
    ),
}
